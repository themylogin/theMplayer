...
# Generated by qmake (2.01a) (Qt 4.8.2) on: ?? ???. 12 17:07:39 2012
...
SOURCES       = main.cpp \
		...
		GridLayoutScrollerWithCursor.cpp moc_SetupDialog.cpp
OBJECTS       = main.o \
		SetupDialog.o \
		Utils.o \
		GridLayout.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/theMplayer1.0.0/ && $(COPY_FILE) --parents SetupDialog.h main.h Utils.h GridLayout.h SetupDialogPreview.h GridLayoutDrawingDirection.h GridLayoutScrollingDirection.h GridLayoutScroller.h GridLayoutScrollerWithCursor.h .tmp/theMplayer1.0.0/ && $(COPY_FILE) --parents main.cpp SetupDialog.cpp Utils.cpp GridLayout.cpp SetupDialogPreview.cpp GridLayoutScroller.cpp GridLayoutScrollerWithCursor.cpp .tmp/theMplayer1.0.0/ && (cd `dirname .tmp/theMplayer1.0.0` && $(TAR) theMplayer1.0.0.tar theMplayer1.0.0 && $(COMPRESS) theMplayer1.0.0.tar) && $(MOVE) `dirname .tmp/theMplayer1.0.0`/theMplayer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/theMplayer1.0.0
