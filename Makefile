...
# Generated by qmake (2.01a) (Qt 4.8.2) on: ?? ???. 12 16:34:50 2012
...
SOURCES       = main.cpp \
		...
		GridLayout.cpp \
		SetupDialogPreview.cpp moc_SetupDialog.cpp
OBJECTS       = main.o \
		SetupDialog.o \
		ScrollableGrid.o \
		Utils.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/theMplayer1.0.0/ && $(COPY_FILE) --parents SetupDialog.h main.h ScrollableGrid.h DrawingDirection.h ScrollingDirection.h Utils.h ScrollableGridWithCursor.h GridLayout.h SetupDialogPreview.h .tmp/theMplayer1.0.0/ && $(COPY_FILE) --parents main.cpp SetupDialog.cpp ScrollableGrid.cpp Utils.cpp ScrollableGridWithCursor.cpp GridLayout.cpp SetupDialogPreview.cpp .tmp/theMplayer1.0.0/ && (cd `dirname .tmp/theMplayer1.0.0` && $(TAR) theMplayer1.0.0.tar theMplayer1.0.0 && $(COMPRESS) theMplayer1.0.0.tar) && $(MOVE) `dirname .tmp/theMplayer1.0.0`/theMplayer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/theMplayer1.0.0
