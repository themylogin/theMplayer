...
# Generated by qmake (2.01a) (Qt 4.8.2) on: ?? ???. 7 21:37:16 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/theMplayer1.0.0/ && $(COPY_FILE) --parents SetupDialog.h main.h Utils.h GridLayout.h SetupDialogPreview.h GridLayoutDrawingDirection.h GridLayoutScrollingDirection.h GridLayoutScroller.h GridLayoutScrollerWithCursor.h Movie.h MovieCollection.h MovieCollectionModel.h MovieFile.h MovieCollectionItem.h .tmp/theMplayer1.0.0/ && $(COPY_FILE) --parents main.cpp SetupDialog.cpp Utils.cpp GridLayout.cpp SetupDialogPreview.cpp GridLayoutScroller.cpp GridLayoutScrollerWithCursor.cpp Movie.cpp MovieCollection.cpp MovieCollectionModel.cpp MovieFile.cpp .tmp/theMplayer1.0.0/ && (cd `dirname .tmp/theMplayer1.0.0` && $(TAR) theMplayer1.0.0.tar theMplayer1.0.0 && $(COMPRESS) theMplayer1.0.0.tar) && $(MOVE) `dirname .tmp/theMplayer1.0.0`/theMplayer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/theMplayer1.0.0
