...
# Generated by qmake (2.01a) (Qt 4.8.2) on: ?? ???. 12 16:12:41 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/theMplayer1.0.0/ && $(COPY_FILE) --parents SetupDialog.h main.h ScrollableGrid.h DrawingDirection.h ScrollingDirection.h Utils.h ScrollableGridWithCursor.h GridLayout.h TestMovieWidget.h .tmp/theMplayer1.0.0/ && $(COPY_FILE) --parents main.cpp SetupDialog.cpp ScrollableGrid.cpp Utils.cpp ScrollableGridWithCursor.cpp GridLayout.cpp TestMovieWidget.cpp .tmp/theMplayer1.0.0/ && (cd `dirname .tmp/theMplayer1.0.0` && $(TAR) theMplayer1.0.0.tar theMplayer1.0.0 && $(COMPRESS) theMplayer1.0.0.tar) && $(MOVE) `dirname .tmp/theMplayer1.0.0`/theMplayer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/theMplayer1.0.0
...
compiler_moc_header_make_all: moc_SetupDialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_SetupDialog.cpp
